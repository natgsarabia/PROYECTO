...
(3,'¿Cuál de las siguientes opciones te resultaría más difícil manejar?', 'Soledad', 'Frío', ' Hambre', 'Aburrimiento') ,
(4,'¿Qué es lo que más anhelas aprender en Hogwarts',' Magia',' Criaturas mágicas',' Secretos',' Maleficios') ,
...
(6,'Te encuentras con un Dementor en el tren', 'Analizar sus debilidades', ' Esconderse', 'Correr', 'Realizar el encantamiento Patronus') ,
(7,'¿Cuál es tu cualidad más valorada?',' Valentía','Lealtad','Inteligencia','Astucia') ,
...
(10,'¿Que cualidad crees que te llevara al éxito?','Valentia','Inteligencia','Lealtad','Ambición') ,
(11,'¿Que hechizo te gustaría dominar a la perfección?','Expecto Patronum','Accio','Lumos','Expelliarmus') ,
...
(20,'¿Que te atrae mas de la magia?','Crear ilusiones','Cambiar la realidad','Conexion con el mundo espiritual','Superar los limites de la fisica') ,
